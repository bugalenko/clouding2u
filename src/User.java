...
public class User {
	...
	private static HashMap<String,User> mapById=new HashMap<String,User>();
	private static HashMap<String,User> mapByUsername=new HashMap<String,User>();
	private static HashMap<String,User> mapByEmail=new HashMap<String,User>();
	private static HashMap<String,User> mapByFirstName=new HashMap<String,User>();
	private static HashMap<String,User> mapByLastName=new HashMap<String,User>();
	...
	static public int update(User user){
		JsonObject bodyObj=(JsonObject) new GsonBuilder().create().toJsonTree(user);
		bodyObj.remove("id");
		bodyObj.remove("password");
		User.operations.updateUser(user.getId(), bodyObj);
		return 0;
		
	}
	static public HashMap<String,User> query(UserQueryBy sortBy){
